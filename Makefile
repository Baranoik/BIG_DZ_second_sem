...
test_04a.o: tests/test_04a.cpp Field.h objects/Player.h objects/Obj.h Render.h Interaction_sys.h Obj_manager.h
	g++ -I. -Iobjects -c tests/test_04a.cpp -DLOGQM -o test_04a.o
#=================================================
#								   Линковка тестов
